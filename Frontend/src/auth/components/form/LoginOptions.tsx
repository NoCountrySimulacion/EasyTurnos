...
export default function LoginOptions(): React.ReactElement {
	...
	return (
		<div className='w-[820px] h-[500px] flex flex-col items-center gap-4 '>
			<h2 className=' text-3xl font-semibold font-["Montserrat"] p-3'>
				¿Cómo te gustaría Iniciar?
			</h2>
			<div
				onClick={() => navigate('/login')}
				className='min-w-[600px] max-w-[600px] h-[200px] flex flex-col items-center gap-4 cursor-pointer'
			>
			...
			>
				<div className='min-w-[600px] max-w-[600px] p-4 bg-white rounded-3xl shadow border border-t-0  flex flex-col md:flex-row justify-start items-center gap-4 md:gap-8'>
					<div className='flex justify-center items-center w-full md:w-1/2'>
						<img
							className='w-full h-auto md:h-55 rounded-2xl object-cover'
