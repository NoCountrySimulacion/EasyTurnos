						...
						<form className='space-y-6' onSubmit={handleSubmit}>
							...
							<div>
								<button
									...
									className='w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-[#FD8847] hover:bg-orange-500 transition duration-300 ease-in-out'
								>
									{isSubmitting ? (
										<>
											<svg
