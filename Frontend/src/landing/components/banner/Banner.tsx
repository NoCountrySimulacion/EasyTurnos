	...
	return (
		<div className='w-full h-[500px] relative rounded-[7.14px]'>
			<img
				...
				className='w-full h-full object-cover rounded-[7.14px] absolute z-0 max-md:object-left '
			/>
			<div className='h-full w-1/2 absolute  flex-col justify-center items-center inline-flex z-10 max-md:pl-10 max-sm:pl-40'>
				...
				<div className='w-[340px] h-[90px] p-2.5 flex-col gap-3 flex '>
					<span className="w-[230px] h-[60px] p-2.5 bg-orange-400 rounded-xl shadow border-b border-black justify-center items-center inline-flex cursor-pointer text-black text-[19px] font-bold font-['Montserrat'] hover:bg-orange-500 transition duration-300 ease-in-out">
