...
export const searchContext = createContext<SearchValueProps>({} as SearchValueProps)
...
export function SearchProvider({ children }: { children: React.ReactNode }) {
    ...
    const filterClientsAppointmentsList = (valueToFilter: ClientAppointmentList): ClientAppointmentList => {
    ...
    const filterClients = (valueToFilter: ClientsByProfessional): ClientsByProfessional => {
    ...
    const filterProfessionalsAppointmentsList = (valueToFilter: ProfessionalAppointmentList): ProfessionalAppointmentList => {
        if (!valueToFilter?.data) {
            return valueToFilter
        }
    ...
    const filterProfessionals = (valueToFilter: ProfessionalsByClient): ProfessionalsByClient => {
        if (!valueToFilter?.data?.length) {
            return valueToFilter
        }
